Efficiency Score Calculator Δ (v1.0)


This C program is a personal habit tracker that evaluates daily discipline and computes a weekly Efficiency Score.
...
Points are awarded for positive habits, with penalties applied in case of failure.
The daily scores are stored in an array.
